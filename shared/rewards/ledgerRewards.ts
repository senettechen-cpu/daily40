import { activeGrants, planGrant, planReversal, PlannedEntry, RewardBook } from './book';
...
export function onExpenseRecorded(book: RewardBook, expenseId: string, recordedAt: Date, timeZone = DEFAULT_TIME_ZONE): PlannedEntry | null {
...
export function onExpenseDeleted(book: RewardBook, expenseId: string, at: Date, timeZone = DEFAULT_TIME_ZONE): PlannedEntry | null {
