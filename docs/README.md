...
[生活軍需、軍械庫、飛昇與六人戰術](progression-economy-ascension-v1.5.md) 已取代 v1.4 相衝突的定位與數值。遊戲獎勵主要購裝備、軍團可擴編、器官綁定個別候選人。另有 [HTML 研究審閱版](progression-review.html)。收入規則已由使用者修訂，見 [v1.5 經濟與技術決策紀錄](v1.5-economy-decisions.md)（優先於 v1.5 第 2–3 節）。下方較早版本說明作歷史索引，不覆蓋 v1.5。
...
使用者於 2026-09-25 改定：**GPT 只負責美術設計與產出圖片；Claude 負責技術架構／系統規劃、程式實作、測試，以及遊戲規則與數值的提案；規則與數值由使用者決定。** 完整交付、變更與驗收責任見主規格第 0 節。
...
> 請先讀專案根目錄 CLAUDE.md 及 docs/expedition-rpg-design.md 全文。依使用者指定分工，你負責技術架構、系統、程式、測試與規則／數值提案；GPT 只負責美術與圖片。先盤點目前原型與規格的差異，提出第一個戰鬥品質切片的技術方案、工作清單、素材依賴、待決問題與測試計畫，待我確認後再實作。不要套用封存的四人行商浪人版本，不要直接展開所有勢力或修改正式存檔。
